...
plugin_identifier = "TwinDragon600x300TouchUI"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "octoprint_TwinDragon600x300TouchUI"

# The plugin's human readable name. Can be overwritten within OctoPrint's internal data via __plugin_name__ in the
# plugin module
plugin_name = "Octoprint-TwinDragon600x300TouchUI"
...
# module
plugin_description = """TouchScreen Plugin for TwinDragon6 600x300 TouchUI"""
...
plugin_url = "https://github.com/FracktalWorks/TwinDragon600x300TouchUI"
